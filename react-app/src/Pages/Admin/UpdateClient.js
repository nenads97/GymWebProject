...
export const UpdateClient = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://localhost:7095/api/Administrators/ClientGetCurrent/${clientId}`
      )
      .then((response) => {
  ...
  function updateClientHandler(event) {
    ...
    axios
      .put(
        `https://localhost:7095/api/Administrators/UpdateClient/${clientId}`,
        payload
      )
      .then((response) => {
        navigate("/administrator/1/clients");
      })
      .catch((error) => {
    ...
    <>
      ...
      <div className="client-register-page">
        <div className="auth-form-container auth-form-container-black">
          <h2 className="register-header-white">Update Client</h2>
