...
export const UpdateTrainer = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://localhost:7095/api/Administrators/TrainerGetCurrent/${trainerId}`
      )
      .then((response) => {
        const trainerData = response.data;

        setEmail(trainerData.email);
        setFirstname(trainerData.firstname);
        setGender(trainerData.gender);
        setJmbg(trainerData.jmbg);
        setPass(trainerData.password);
        setPhoneNumber(trainerData.phoneNumber);
  ...
  function updateTrainerHandler(event) {
    ...
    axios
      .put(
        `https://localhost:7095/api/Administrators/UpdateTrainer/${trainerId}`,
        payload
      )
      .then((response) => {
        navigate("/administrator/1/trainers");
      })
      .catch((error) => {
    ...
    <>
      <div className="trainer-register-page">
        <div className="auth-form-container auth-form-container-black">
          <h2 className="register-header-white">Update Trainer</h2>

          <form className="register-form" onSubmit={updateTrainerHandler}>
