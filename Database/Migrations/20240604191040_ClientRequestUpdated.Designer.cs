...
namespace Database.Migrations
{
    ...
    [Migration("20240604191040_ClientRequestUpdated")]
    partial class ClientRequestUpdated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Database.Entities.PackagePrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PackagePriceId = 1,
                            AdministratorId = 1,
                            Date = new DateTime(2024, 6, 4, 21, 10, 39, 319, DateTimeKind.Local).AddTicks(4614),
                            PackageId = 1,
                            Value = 3000.0
                        },
                        new
                        {
                            PackagePriceId = 2,
                            AdministratorId = 1,
                            Date = new DateTime(2024, 6, 4, 21, 10, 39, 319, DateTimeKind.Local).AddTicks(4652),
                            PackageId = 2,
                            Value = 4500.0
                        },
                        new
                        {
                            PackagePriceId = 3,
                            AdministratorId = 1,
                            Date = new DateTime(2024, 6, 4, 21, 10, 39, 319, DateTimeKind.Local).AddTicks(4656),
                            PackageId = 3,
                            Value = 8000.0
                        });
                });
            ...
            modelBuilder.Entity("Database.Entities.TokenPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TokenPriceId = 1,
                            AdministratorId = 1,
                            Date = new DateTime(2024, 6, 4, 21, 10, 39, 319, DateTimeKind.Local).AddTicks(4695),
                            TokenId = 1,
                            Value = 1000.0
                        },
                        new
                        {
                            TokenPriceId = 2,
                            AdministratorId = 1,
                            Date = new DateTime(2024, 6, 4, 21, 10, 39, 319, DateTimeKind.Local).AddTicks(4699),
                            TokenId = 2,
                            Value = 500.0
                        });
                });
