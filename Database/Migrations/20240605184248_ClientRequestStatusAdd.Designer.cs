...
namespace Database.Migrations
{
    ...
    [Migration("20240605184248_ClientRequestStatusAdd")]
    partial class ClientRequestStatusAdd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Database.Entities.PackagePrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PackagePriceId = 1,
                            AdministratorId = 1,
                            Date = new DateTime(2024, 6, 5, 20, 42, 47, 846, DateTimeKind.Local).AddTicks(8204),
                            PackageId = 1,
                            Value = 3000.0
                        },
                        new
                        {
                            PackagePriceId = 2,
                            AdministratorId = 1,
                            Date = new DateTime(2024, 6, 5, 20, 42, 47, 846, DateTimeKind.Local).AddTicks(8243),
                            PackageId = 2,
                            Value = 4500.0
                        },
                        new
                        {
                            PackagePriceId = 3,
                            AdministratorId = 1,
                            Date = new DateTime(2024, 6, 5, 20, 42, 47, 846, DateTimeKind.Local).AddTicks(8247),
                            PackageId = 3,
                            Value = 8000.0
                        });
                });
            ...
            modelBuilder.Entity("Database.Entities.TokenPrice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TokenPriceId = 1,
                            AdministratorId = 1,
                            Date = new DateTime(2024, 6, 5, 20, 42, 47, 846, DateTimeKind.Local).AddTicks(8291),
                            TokenId = 1,
                            Value = 1000.0
                        },
                        new
                        {
                            TokenPriceId = 2,
                            AdministratorId = 1,
                            Date = new DateTime(2024, 6, 5, 20, 42, 47, 846, DateTimeKind.Local).AddTicks(8295),
                            TokenId = 2,
                            Value = 500.0
                        });
                });
